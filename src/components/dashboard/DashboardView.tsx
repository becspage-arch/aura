  ...
  return (
    <div className="aura-page">
      ...
      <section className="aura-grid-4">
        ...
        <div className="aura-card">
          <div className="aura-stat-label">Aura Profit (All Users)</div>
          <div className="aura-stat-value">{allUsersProfit}</div>
          <div className="aura-stat-sub">Total generated by Aura</div>
        </div>
      </section>
