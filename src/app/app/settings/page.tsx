    ...
    <div className="mx-auto grid max-w-6xl gap-6">
      <div>
        ...
        <p style={{ marginTop: 6, color: "var(--muted-foreground)" }}>
          This page will be where users manage broker connections, notifications, risk caps, and preferences.
      ...
      >
        ...
        <div style={{ color: "var(--muted-foreground)" }}>
          Broker connections, notification settings, risk limits, and account defaults.
        </div>
      </section>
    </div>
  );
